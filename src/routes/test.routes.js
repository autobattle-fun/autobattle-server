...
testRoutes.get(
  "/fire-event/agent-decision/:playerStatus",
  fireEventMethods.fireAgentDecision,
);
testRoutes.get("/fire-event/river-flowing", fireEventMethods.fireRiverFlowing);
testRoutes.get(
  "/fire-event/round-resolved",
  fireEventMethods.fireRoundResolved,
);
testRoutes.get(
  "/fire-event/tiebreaker-started",
  fireEventMethods.fireTiebreakerStarted,
);
testRoutes.get(
  "/fire-event/tiebreaker-resolved",
  fireEventMethods.fireTiebreakerResolved,
);
